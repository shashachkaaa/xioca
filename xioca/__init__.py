...
__update_desc__ = """🌐 Локализация
Добавлена поддержка нескольких языков. Сменить язык можно командой .setlang.
📖 Разработчикам
Документация доступна по ссылке: xioca.ferz.live/docs
🐛 Багфиксы
Исправлена ошибка 400 peer_id_invalid, из-за которой сообщение не редактировалось после перезагрузки.
"""
